...
export const ShopProvider = ({ children }) => {
  ...
  // 1. Dodawanie do koszyka (z uwzględnieniem rozmiaru)
  ...
  // 4. Konwerter Walut (BEZ GROSZY - Pełne Złotówki)
  const formatPrice = (priceInUSD) => {
    ...
    return new Intl.NumberFormat('pl-PL', { 
      style: 'currency', 
      currency: 'PLN',
      minimumFractionDigits: 0, // Zero miejsc po przecinku
      maximumFractionDigits: 0 
    }).format(priceInPLN);
  };

  // Liczenie sumy i ilości
